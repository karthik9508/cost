          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 pt-2">
                ...
                <a href="#" className="w-10 h-10 bg-slate-100 hover:bg-blue-400 hover:text-white text-slate-600 rounded-lg flex items-center justify-center transition-all">
                ...
                <a href="#" className="w-10 h-10 bg-slate-100 hover:bg-pink-600 hover:text-white text-slate-600 rounded-lg flex items-center justify-center transition-all">
                ...
                <a href="#" className="w-10 h-10 bg-slate-100 hover:bg-blue-700 hover:text-white text-slate-600 rounded-lg flex items-center justify-center transition-all">
